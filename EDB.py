...
#from msilib.schema import File, RadioButton, tables
...
from tkinter import *
from tkinter import messagebox, ttk, font ,filedialog , messagebox as mb
#from tkinter import _ButtonCommand #messageboxللتعامل مع رسائل الويندوزfrom curses import mouseinterval  from email import header
from turtle import Screen, down, heading, right, st
from typing import Literal, NamedTuple
#from typing_extensions import Self
from unicodedata import name
from urllib import response
import webbrowser,os,sys,math,random ,tkinter as tk,sys,time,pygame,pandas as pd ,cv2  #mathعمليات حسابية/os التعامل مع النظام مثل حفظ الفواتير/ randomطباعة الفواتير بشكل تلقائى
from PIL import ImageTk, Image
import pymysql #pip install pygame/pymysql/pandas/piLlow/opencv-python/tkcalendar  pip install progressbar
...
#*************************************************************************************************************
p = "E:\\flasha\\New folder (3)\\New folder\\Egyptian Development Bank\\icon\\"  #path  E:\\New folder\\        D:\\     G
fo=('tajawal',16,'bold')
...
options = {
    'Egypt':{
        "":[],
        "Alexandria":["Damietta","Elalyoubia","Elbehira","Eldakahlia","Elfayoum","Elgharbia","Elgiza","Elismailia","Elkalubia","Elminofia","Elminia","Elsharkia","Elsuez","Elwadi Elgidid","Kafr Elsheikh","Luxor","Matoruh","North Sinai","Port Said","Qena","Red Sea","Sohag","South Sinai"],
        "Assuit":[],
        "Aswan":[],
        "Beni Suef":[],
        "Cairo":[],
...
class Window(Tk):
    ...
    def start(self):
        ...
        t1 = Label (f , text='UTILIZATION OF GIS AND REMOTE SENSING TECHNOLOGY ON',fg='gold',bg='#0B2F3A',font=fo) 
        t1.place(x=400,y=90)
        t2 = Label (f , text='IRRIGATION WATER MANAGEMENT IN THE NORTH DLTA',fg='gold',bg='#0B2F3A',font=fo) 
        t2.place(x=440,y=120)
        t3 = Label (f , text='OF EGYPT AS A CASE STUDY',fg='gold',bg='#0B2F3A',font=('tajawal',16,'bold')) 
        t3.place(x=540,y=150)
        t4 = Label (f , text='"Egyptian Development Bank" (EDB) Model',fg='red',bg='#0B2F3A',font=('tajawal',16,'bold')) 
        t4.place(x=470,y=200)

        t5 = Label (f , text='Developed by',fg='white',bg='#0B2F3A',font=('tajawal',16,'bold')) 
        t5.place(x=615,y=270)
        t6 = Label (f , text='Nader Elsayed Saad Rizq Zahem',fg='gold',bg='#0B2F3A',font=('tajawal',16,'bold')) 
        t6.place(x=530,y=320)
        t7 = Label (f , text='B.Sc.,Agric. Engineering, Al-Azhar University, Egypt',fg='white',bg='#0B2F3A',font=('tajawal',16,'bold')) 
        t7.place(x=450,y=350)

        t8 = Label (f , text='Supervisor',fg='white',bg='#0B2F3A',font=('tajawal',16,'bold')) 
        t8.place(x=620,y=400)

        t9 = Label (f , text='Prof.Dr.',fg='white',bg='#0B2F3A',font=('tajawal',16,'bold')) 
        t9.place(x=230,y=450)
        t10 = Label (f , text='Mohamed Maher Ibrahim',fg='gold',bg='#0B2F3A',font=('tajawal',16,'bold')) # Abd Elal
        t10.place(x=150,y=480)
        t11 = Label (f , text='Assistant Professor at Irrigation and drainage Agricultural ',fg='white',bg='#0B2F3A',font=('tajawal',16,'bold')) 
        t11.place(x=5,y=510)
        t12 = Label (f , text='Engineering Department, Faculty of Agriculture,',fg='white',bg='#0B2F3A',font=('tajawal',16,'bold')) 
        t12.place(x=60,y=540)
        t13 = Label (f , text='Mansoura University, Egypt',fg='white',bg='#0B2F3A',font=('tajawal',16,'bold')) 
        t13.place(x=140,y=570)

        t14 = Label (f , text='Prof.Dr.',fg='White',bg='#0B2F3A',font=('tajawal',16,'bold')) 
        t14.place(x=1050,y=450)
        t15 = Label (f , text='Nadia Gamal Abd Elfattah Daoud',fg='gold',bg='#0B2F3A',font=('tajawal',16,'bold')) 
        t15.place(x=930,y=480)
        t16 = Label (f , text='Lecturer at Irrigation and drainage of Agricultural',fg='white',bg='#0B2F3A',font=('tajawal',16,'bold'))
        t16.place(x=850,y=510)
        t17 = Label (f, text='Engineering Department, Faculty of Agriculture,',fg='white',bg='#0B2F3A',font=('tajawal',16,'bold')) 
        t17.place(x=860,y=540)
        t18 = Label (f , text='Mansoura University, Egypt',fg='white',bg='#0B2F3A',font=('tajawal',16,'bold')) 
        t18.place(x=960,y=570)

        t19 = Label (f , text='Version 1.0',fg='white',bg='#0B2F3A',font=('tajawal',14)) 
        ...
        b1 = Button(f, text= 'Exit',font=('tajawal',17,'bold'),width=10,bd=5,height=1, fg='black',bg='red',command= self.sd)
    ...
    def home(self):
        ...
        f1 = Frame(f,bd=2,width=300, height=300, bg='gold')  #bd 2d/3dنوع البرورد       وممكن لاتحدد الطول والعرض أوتضيفة على على السطر التالى
        f1.place(x=530,y=200)

        t1 = Label (f1 , text='EDB system login',fg='black',bg='gold',font=('tajawal',14)) 
        t1.place(x=70,y=0)
        ...
        e1.place(x=110,y=35)
        e2=Entry(f1,width=30,bd=3,justify='center') #justify='right',height=1  /textvarible=  /
        e2.place(x=110,y=65)

        b2 = Button(f1, text= 'Exit',font=('tajawal',17,'bold'),width=6,bd=3,height=1, fg='black',bg='red',command=self.page1(self.start))#destroy /quit
        b2.place(x=50,y=130)
        b1 = Button(f1, text= 'Sign In',font=('tajawal',17,'bold'),width=6,bd=3, fg='black',bg='red', command= self.page1(self.page2))
    ...
    def page2(self):
        ...
        b5 = Button(f1, text= 'Add land',font=('tajawal'),width=11,bd=3, fg='black',bg='red',command= self.Add_land)
        b5.pack()
        b2 = Button(f1, text= 'Add data',font=('tajawal'),width=11,bd=3, fg='black',bg='red',command= self.Add_data1)
        b2.pack(pady=0)
        b1 = Button(f1, text= 'Feedback Data',font=('tajawal'),width=11,bd=3, fg='black',bg='red',command= self.feedback_Data)#,height=1
        b1.pack()#pady=20
        b4 = Button(f1, text= 'RAC',font=('tajawal'),width=11,bd=3, fg='black',bg='red')
        b4.pack(pady=0)
        b4 = Button(f1, text= 'Crop selection',font=('tajawal'),width=11,bd=3, fg='black',bg='red')
        b4.pack()
        b4 = Button(f1, text= 'incoming mail',font=('tajawal'),width=11,bd=3, fg='black',bg='red')
        b4.pack(pady=0)
        b3 = Button(f1, text= 'Search',font=('tajawal'),width=11,bd=3, fg='black',bg='red',command= self.say_hello)#,command= self.play
        b3.pack()
        b4 = Button(f1, text= 'Settings',font=('tajawal'),width=11,bd=3, fg='black',bg='red',command= self.Settings)
        b4.pack(pady=0)
        b6 = Button(f1, text= 'Help',font=('tajawal'),width=11,bd=3, fg='black',bg='red',command= self.Help)
        b6.pack()
        b7 = Button(f1, text= 'Exit',font=('tajawal'),width=11,bd=3, fg='black',bg='red',command= self.page1(self.start))#   .grid(row=0, column=2) ,command= self.start
        b7.pack(pady=0)
...
#***********************************************************
    def Add_land (self): #static scope
        f = Frame(self,bd=2,width=self.w, height=self.h, bg='white')#bd 2d/3dنوع البرورد       وممكن لاتحدد الطول والعرض أوتضيفة على على السطر التالى   ,width=1247, height=704
        f.place(x=117,y=0)
        ...
        t = Label (f1 , text='Telephone number :',fg='black',bg='gold',font=('tajawal',14)) 
        t.place(x=0,y=205)
        ...
        e0.place(x=95,y=30)
        e1=Entry(f1,width=32,bd=3,fg='black',justify='center') #justify='right',height=1
        e1.place(x=106,y=60)
        e2=Entry(f1,width=15,bd=3,fg='black',justify='center') #justify='right',height=1
        e2.place(x=180,y=210)
        e3=Entry(f1,width=30,bd=3,fg='black',justify='center') #justify='right',height=1
        e3.place(x=106,y=240)
        e4=Entry(f1,width=30,bd=3,fg='black',justify='center') #justify='right',height=1
        e4.place(x=106,y=330)
        e5=Entry(f1,width=30,bd=3,fg='black',justify='center') #justify='right',height=1
        ...
        b7 = Button(f1, text= 'Exit',font=('tajawal'),width=11,bd=3, fg='black',bg='red',command= save_data)#   .grid(row=0, column=2) ,command= self.start
        ...
        def country_changed(*args):
            ...
            c=ttk.Combobox(f1, width=11, values=values, textvariable=self.gov, font='tajawal')
            c.place(x=120,y=150)
            self.gov.trace('w', gov_changed)

        self.country = StringVar()
        c=ttk.Combobox(f1, width=5, values= list(options.keys()), textvariable=self.country, font='tajawal')
        c.place(x=79,y=120)
        ...
        def gov_changed(*args):
            ...
            c=ttk.Combobox(f1, width=5, values=values, textvariable=self.city, font='tajawal')
            c.place(x=50,y=180)
        ...
        def listbox_selected(event):
            ...
            t.place(x=55,y=0)
            t2= Label (f1 , text='R\u2099:',fg='black',bg='gold',font=('tajawal',14)) #Rn
            t2.place(x=0,y=20)
            t3= Label (f1 , text='G :',fg='black',bg='gold',font=('tajawal',14)) 
            t3.place(x=0,y=46)
            t4= Label (f1 , text='\u0394 :',fg='black',bg='gold',font=('tajawal',14)) #dlta
            t4.place(x=0,y=72)
            t5= Label (f1 , text='U\u2082:',fg='black',bg='gold',font=('tajawal',14)) #u2
            t5.place(x=0,y=98)
            t6= Label (f1 , text='e\u209b:',fg='black',bg='gold',font=('tajawal',14)) #es
            t6.place(x=0,y=124)
            t7= Label (f1 , text='e\u2090:',fg='black',bg='gold',font=('tajawal',14)) #ea
            t7.place(x=0,y=150)
            t8= Label (f1 , text='T :',fg='black',bg='gold',font=('tajawal',14)) 
            t8.place(x=0,y=176)
            t9= Label (f1 , text='\u0194 :',fg='black',bg='gold',font=('tajawal',14)) #gama
            t9.place(x=0,y=202)
            t9= Label (f1 , text='ET\u2092',fg='red',bg='gold',font=('tajawal',14)) #ETo
            t9.place(x=0,y=227)
            ...
            t12.place(x=0,y=406)
            t12= Label (f1 , text='Readily available water',fg='red',bg='gold',font=('tajawal',14)) #ETc
            t12.place(x=0,y=427)

            t18= Label (f1 , text='AW :',fg='black',bg='gold',font=('tajawal',14)) 
            t18.place(x=0,y=450)
            t19= Label (f1 , text='Z\u1d63  :',fg='black',bg='gold',font=('tajawal',14)) #zr
            t19.place(x=0,y=476)
            ...
            t21= Label (f1 , text='Leaching Requirements',fg='red',bg='gold',font=('tajawal',14)) 
            t21.place(x=0,y=548)
            ...
            e1=Entry(f1,width=9,bd=3,fg='red',justify='center') #justify='right',height=1
            e1.place(x=39,y=23)
            e2=Entry(f1,width=9,bd=3,justify='center') #justify='right',height=1  /textvarible=  /
            e2.place(x=39,y=49)
            e3=Entry(f1,width=9,bd=3,justify='center') #  ,textvariable=name استدعاء المتغير -----+ name=stringvar()
            e3.place(x=39,y=75)
            ...
            e8.place(x=39,y=205)
            e9=Entry(f1,width=9,bd=3,justify='center',relief=SUNKEN,textvariable=sys.displayhook) 
            e9.place(x=39,y=231)
            ...
            e21=Entry(f1,width=9,bd=3,justify='center') #justify='right',height=1  /textvarible=  / ,fg='red'
            e21.place(x=55,y=627)
            e22=Entry(f1,width=9,bd=3,justify='center') 
            e22.place(x=55,y=653)

            t2s.place(x=100,y=25)
            t3s= Label (f1 , text='MJ.m\u00b2/day',fg='black',bg='gold',font=('tajawal',14)) 
            ...
            t9s= Label (f1 , text='KP\u2090/\u00B0c',fg='black',bg='gold',font=('tajawal',14)) 
        ...
        listbox=Listbox(f2,width=30,height=5,fg='red',bd=0,)
        ...
        b6 = tk.Button(f2, text= 'Add',font=('tajawal'),bd=3, fg='black',bg='red',command=add).place(x=0,y=60)
        b6 = tk.Button(f2, text= 'Delete',font=('tajawal'),bd=3, fg='black',bg='red',command=delete).place(x=50,y=60)

        name=tk.StringVar()

        tk.Entry(f2,width=20,bd=3,fg='black',justify='center',textvariable=name).place(x=75,y=30)
...
#class kj(Label):        
    ...
    def add(self):
        ...
        li.insert(END,n)
        li.place(x=0,y=300)
        e1=tk.Entry(self,width=32,bd=3,fg='black',justify='center',textvariable=name) #justify='right',height=1
        e1.place(x=95,y=30)
        n=name.get()
...
#*********************************************
    def Add_data1 (self):
        ...
        t = Label (f1 , text='Select Country :',fg='black',bg='gold',font=('tajawal',14)) 
        t.place(x=0,y=0)
        t = Label (f1 , text='Select Witch your data will see?',fg='red',bg='gold',font=('tajawal',14)) 
        t.place(x=0,y=25)
        t = Label (f1 , text='Governorate :',fg='black',bg='gold',font=('tajawal',14)) 
        t.place(x=0,y=85)
        t = Label (f1 , text='City :',fg='black',bg='gold',font=('tajawal',14)) 
        ...
        b = Button(f1, text= 'Enter',font=('tajawal',17,'bold'),bd=5, fg='black',bg='red',command= self.next)
        b.place(x=50,y=500)
...
#*******************************************select****************************************************************
        ...
        c.current(0)
        c.bind("<<ComboboxSelected>>") # ,comboclick / def comboclick(event): / m= label(root, text= c.get()).pack()
        c.place(x=140,y=5)

        Options=["","Governorate","City","Basin","field ID","Full name","National ID"]
        clicked=StringVar()
        clicked.set(Options[0])
        ...
        Options=["","Alexandria","Assuit","Aswan","Beni Sweif","Cairo","Damietta","Eldakahlia","Kafr Elsheik","Elbehira","Elgharbia","Elminofia","Elsharkia","Elkalubia","Elgiza","Elfayoum","Elminia","Sohag","Qena","","","" ]
        clicked=StringVar()
        clicked.set(Options[0])
        ...
        Options=["","Elgamalia","Elmansura","City","Basin","ID Land","Name","ID"]
        clicked=StringVar()
        clicked.set(Options[0])
    ...
    def feedback_Data (self):
        table = DataTable(self, bd=2, width=self.w, height=self.h, bg='white') #bd 2d/3dنوع البرورد       وممكن لاتحدد الطول والعرض أوتضيفة على على السطر التالى
...
#****************************************************************************************************************************************************
    def shose_crops (self):
        ...
        t2s= Label (f1 , text='MJ.m\u00b2/day',fg='black',bg='gold',font=('tajawal',14)) 
        t2s.place(x=100,y=25)
        t3s= Label (f1 , text='MJ.m\u00b2/day',fg='black',bg='gold',font=('tajawal',14)) 
        t3s.place(x=100,y=49)
        t4s= Label (f1 , text='m/s',fg='black',bg='gold',font=('tajawal',14)) 
        ...
        Options=["","rice","sugar beet","potato","wheat","tomato","cotton","cucumber"]
        clicked=StringVar()
        clicked.set(Options[0])
        ...
        c2.current(0)
        c2.bind("<<ComboboxSelected>>") # ,comboclick / def comboclick(event): / m= label(root, text= c.get()).pack()
        c2.place(x=90,y=577)

        #*****************************الاطار الثانى*****************************************
        t25= Label (f2 , text='Soil water depletion',fg='red',bg='gold',font=('tajawal',14)) 
        t25.place(x=15,y=0)
        ...
        t29= Label (f2 , text='If selected rice',fg='red',bg='gold',font=('tajawal',14)) 
        t29.place(x=0,y=145)
        t30= Label (f2 , text='PERC',fg='black',bg='gold',font=('tajawal',14)) 
        t30.place(x=0,y=166)
        t31= Label (f2 , text='Regular irrigation :',fg='black',bg='gold',font=('tajawal',14)) 
        t31.place(x=0,y=187)
        t31= Label (f2 , text='D\u1d63\u1d62 :',fg='black',bg='gold',font=('tajawal',14)) 
        t31.place(x=0,y=212)
        t27= Label (f2 , text='Dg =',fg='red',bg='gold',font=('tajawal',14)) 
        t27.place(x=0,y=233)
        t32= Label (f2 , text='Sat irrigation :',fg='black',bg='gold',font=('tajawal',14)) 
        t32.place(x=0,y=258)
        t32= Label (f2 , text='SAT :',fg='black',bg='gold',font=('tajawal',14)) 
        t32.place(x=0,y=281)
        t27= Label (f2 , text='Dg =',fg='red',bg='gold',font=('tajawal',14)) 
        t27.place(x=0,y=304)
        t33= Label (f2 , text='1st irrigation in midstage',fg='black',bg='gold',font=('tajawal',14)) 
        t33.place(x=0,y=329)
        ...
        t33= Label (f2 , text='Canal`s available water',fg='red',bg='gold',font=('tajawal',14)) 
        t33.place(x=0,y=400)
        t33= Label (f2 , text='Qf',fg='black',bg='gold',font=('tajawal',14)) 
        t33.place(x=0,y=423)
        t33= Label (f2 , text='Af',fg='black',bg='gold',font=('tajawal',14)) 
        t33.place(x=0,y=446)
        t33= Label (f2 , text='L\u2092\u2099 :',fg='black',bg='gold',font=('tajawal',14)) 
        t33.place(x=0,y=472)
        ...
        t33.place(x=0,y=549)
        t33= Label (f2 , text='If selected rice :',fg='red',bg='gold',font=('tajawal',14)) 
        t33.place(x=0,y=570)
        t33= Label (f2 , text='1st irrigation in midstage',fg='black',bg='gold',font=('tajawal',14)) 
        t33.place(x=0,y=591)
        t33= Label (f2 , text='GIR =',fg='red',bg='gold',font=('tajawal',14)) 
        t33.place(x=0,y=616)
        t33= Label (f2 , text='Regular irrigation :',fg='black',bg='gold',font=('tajawal',14)) 
        t33.place(x=0,y=637)
        t33= Label (f2 , text='GIR =',fg='red',bg='gold',font=('tajawal',14)) 
        t33.place(x=0,y=662)
        ...
        t20s= Label (f2 , text='m\u00b3/feed.day',fg='black',bg='gold',font=('tajawal',14)) 
...
#******************************************** الاطار رقم 3 ***************************************************
        t33= Label (f3 , text='Sat irrigation :',fg='black',bg='gold',font=('tajawal',14)) 
        t33.place(x=0,y=0)
...
#**********************************************************************************************************
    ...
    #def EDB_App(self):
        #con=pymysql.connector(host='localhost',user='root',password='',database='EDB_App')
        #cur=con.cursor()
    ...
    def add(self):
        con=pymysql.connector(host='localhost',user='root',password='',database='EDB_App')
        cur=con.cursor()
        if (len(name_var.get())==0 or len(telephon_var.get())==0 or len(National_ID_var.get())==0):
