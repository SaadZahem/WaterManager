...
label_train =Label(root, text="Click Start for training", font='arial 15 bold', style='green/white.TLabel')
label_train.pack(padx=20, pady=15)

label_progress = Label(root, font='arial 12 bold')
label_progress.pack(padx=100, pady=3)

progress = Progressbar(root, style="TProgressbar", length=250, mode="determinate")
